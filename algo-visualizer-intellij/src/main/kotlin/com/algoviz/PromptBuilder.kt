 ...
 * render() so the IDE can sync the editor cursor.
 *
 * Kotlin port of vscode-extension/src/promptBuilder.ts — keep in sync.
 */
object PromptBuilder {
    fun build(code: String, hint: String): String {
        val hintBlock = if (hint.isNotBlank()) "## VISUALIZATION GUIDANCE\n$hint\n" else ""
